...
export const metadata: Metadata = {
  ...
  description:
    "Tips, guides, and insights on document scanning, e-signatures, and productivity.",
  openGraph: {
    title: "Blog | PDF Scan Fast",
    description:
      "Tips, guides, and insights on document scanning, e-signatures, and productivity.",
  },
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Tips, guides, and insights on document scanning, e-signatures, and
              productivity.
            </p>
          </div>
          {posts.length === 0 ? (
