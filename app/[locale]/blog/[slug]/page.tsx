...
// Types for translated article content
...
// Load a translated article from JSON file (falls back to null if not found)
...
function ArticleCTA({
  ...
  return (
    <div className="mt-12 rounded-2xl bg-primary p-8 sm:p-10 text-center text-white">
      <h3 className="text-xl sm:text-2xl font-bold mb-3">{t.title}</h3>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <a
          href="#"
          className="inline-flex items-center justify-center gap-2 rounded-full h-11 px-6 font-semibold bg-white text-primary hover:bg-white/90 transition-colors"
        >
...
function ArticleJsonLd({ post }: { post: BlogPost }) {
  ...
  const jsonLd = {
    ...
    image: imageUrl ? `https://pdfscanfast.com${imageUrl}` : undefined,
    publisher: {
      "@type": "Organization",
      name: "PDF Scan Fast",
      url: "https://pdfscanfast.com",
    },
  };
  return (
    <script
